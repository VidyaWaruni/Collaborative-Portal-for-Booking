...
<div class="row" style="margin-right: 0px">
    <div class="col-md-4 col-sm-4 col-xs-4" >
        <form action="{{route('post_add_apartment')}}" method="post" style="padding-left: 30px;padding-top: 40px" enctype="multipart/form-data">
            <div class="form-group">
                <label for="name" style="font-size: 11px" class="label-control">Apartment Name</label>
                <input  style="font-size: 10px; @if($errors->has('name'))border-color: red @endif " type="text" class="form-control form-control-sm " id="name" name="name" value="{{Request::old('name') ?: ''}}"  placeholder="Apartment Name">
                @if($errors->has('name'))
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('address'))border-color: red @endif " type="text" class="form-control form-control-sm" id="address" name="address" value="{{Request::old('address') ?: ''}}" placeholder="Apartment Address" >
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('contact'))border-color: red @endif " type="text" class="form-control form-control-sm" id="contact" name="contact"  value="{{Request::old('contact') ?: ''}}" placeholder="Apartment Contact" >
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('price'))border-color: red @endif " type="text" class="form-control form-control-sm" id="price" name="price"  value="{{Request::old('prize') ?: ''}}" placeholder="Apartment Price" >
                @if($errors->has('price'))
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('type'))border-color: red @endif " type="text" class="form-control form-control-sm" id="type" name="type"  value="{{Request::old('type') ?: ''}}" placeholder="Apartment Type" >
                @if($errors->has('type'))
            ...
            <div class="form-group ">
                ...
                <textarea  style="font-size: 10px; @if($errors->has('details'))border-color: red @endif " class="form-control form-control-sm" rows="5" id="details" name="details" value="{{Request::old('details') ?: ''}}" placeholder="Apartment Details"></textarea>
            ...
            <div class="form-group ">
                ...
                <input type="file" style="font-size: 10px; @if($errors->has('apartment_image'))border-color: red @endif "  id="apartment_image" name="apartment_image" class="form-control form-control-sm"  value="{{Request::old('apartment_image') ?: ''}}">
            ...
            <button type="submit" class="btn btn-default button-thumbnail" >ADD APARTMENT</button>
                    ...
                    @foreach($availables as $available)
                        @if($available->pro_id == $apartment->id)
                            <tr>
                                ...
                                <td style="padding-left: 20px"><small >{{$available->date_to}}</small></td>
