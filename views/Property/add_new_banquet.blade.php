...
<div class="row" style="margin-right: 0px;margin-bottom: 200px">
    <div class="col-md-4 col-sm-4 col-xs-4" >
        <form action="{{route('post_add_banquet')}}" method="post" style="padding-left: 30px;padding-top: 40px" enctype="multipart/form-data">
            <div class="form-group">
                <label for="name" style="font-size: 11px" class="label-control">Banquet Name</label>
                <input  style="font-size: 10px; @if($errors->has('banquet_name'))border-color: red @endif " type="text" class="form-control form-control-sm " id="banquet_name" name="banquet_name" value="{{Request::old('banquet_name') ?: ''}}"  placeholder="">
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('banquet_address'))border-color: red @endif " type="text" class="form-control form-control-sm" id="banquet_address" name="banquet_address" value="{{Request::old('banquet_address') ?: ''}}" placeholder="" >
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('banquet_contact'))border-color: red @endif " type="text" class="form-control form-control-sm" id="banquet_contact" name="banquet_contact"  value="{{Request::old('banquet_contact') ?: ''}}" placeholder="" >
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('banquet_price'))border-color: red @endif " type="text" class="form-control form-control-sm" id="banquet_price" name="banquet_price"  value="{{Request::old('banquet_price') ?: ''}}" placeholder="" >
            ...
            <div class="form-group ">
                ...
                <input  style="font-size: 10px; @if($errors->has('banquet_capacity'))border-color: red @endif " type="text" class="form-control form-control-sm" id="banquet_capacity" name="banquet_capacity"  value="{{Request::old('banquet_capacity') ?: ''}}" placeholder="" >
            ...
            <div class="form-group ">
                ...
                <input type="file" style="font-size: 10px; @if($errors->has('banquet_image'))border-color: red @endif "  id="banquet_image" name="banquet_image" class="form-control form-control-sm"  value="{{Request::old('banquet_image') ?: ''}}">
            ...
            <button type="submit" class="btn btn-default button-thumbnail" >ADD BANQUET</button>
